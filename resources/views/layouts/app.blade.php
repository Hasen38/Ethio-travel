...
<body class="font-sans antialiased">
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <!-- Navigation Links -->
                    <div class="hidden items-center ml-3 space-between sm:ml-6 sm:flex sm:space-x-8">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    @guest
                        ...
                        <a href="{{ route('register') }}" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md transition duration-150 hover:bg-blue-700">
                            Register
                        </a>
                    @else
                        <div class="relative group">
                            <button class="flex items-center px-3 py-2 text-sm font-medium text-gray-700 rounded-md transition duration-150 hover:text-blue-600 hover:bg-gray-50">
                                <span class="mr-2">{{ Auth::user()->name }}</span>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                            </button>
                            <div class="hidden absolute right-0 py-2 mt-2 w-48 bg-white rounded-md shadow-lg group-hover:block">
                ...
                <div class="flex items-center sm:hidden">
                    <button @click="mobileMenuOpen = !mobileMenuOpen" type="button" class="inline-flex justify-center items-center p-2 text-gray-400 rounded-md transition duration-150 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500" aria-expanded="false">
    ...
    <div :class="{'block': mobileMenuOpen, 'hidden': !mobileMenuOpen}" class="sm:hidden">
        ...
        <div class="pt-4 pb-3 border-t border-gray-200">
            @guest
                <div class="space-y-1">
                    <a href="{{ route('login') }}" class="block py-2 pr-4 pl-3 text-base font-medium text-gray-600 hover:bg-gray-50 hover:text-blue-600">Login</a>
                    <a href="{{ route('register') }}" class="block py-2 pr-4 pl-3 text-base font-medium text-gray-600 hover:bg-gray-50 hover:text-blue-600">Register</a>
                </div>
            @else
                <div class="px-4 space-y-1">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="block py-2 w-full text-base font-medium text-left text-gray-600 hover:text-blue-600">Logout</button>
                    </form>
                </div>
            @endguest
        </div>
    ...
    <footer class="text-white bg-gray-900">
        <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="mt-8 lg:mt-0">
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><i class="mr-2 fas fa-phone"></i> +1 234 567 890</li>
                        <li><i class="mr-2 fas fa-envelope"></i> info@travel.com</li>
                        <li><i class="mr-2 fas fa-map-marker-alt"></i> 123 Travel Street, City</li>
                    </ul>
                </div>
                ...
                <div class="mt-8 lg:mt-0">
                    ...
                    <form class="space-y-2">
                        <input type="email" placeholder="Your email" class="px-4 py-2 w-full text-gray-900 rounded">
                        <button type="submit" class="py-2 w-full text-white bg-blue-600 rounded hover:bg-blue-700">
                            Subscribe
                        </button>
                    </form>
                </div>
            ...
            <div class="pt-8 mt-8 text-center text-gray-400 border-t border-gray-800">
                <p>&copy; {{ date('Y') }} {{ config('app.name', 'Ethio Travel') }}. All rights reserved.</p>
            </div>
        </div>
    </footer>
